...
public class LoginAlunoController : MonoBehaviour
{

    private const string Login = "Aluno";
    private const string Senha = "software";
    ...
    public void FazerLogin()
    {
        ...
        if (usuario == Login && pass == Senha)
        {
            ...
            feedbacking.text = "Usuário ou curso inválidos";
